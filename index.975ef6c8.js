...
function renderCountryList(responceAPI) {
    ...
    if (responceAPI.length === 1) refs.countryInfo.innerHTML = renderCountryInfo(responceAPI[0]);
    else {
...
},{"./css/styles.css":"1CY4s"}],"1CY4s":[function() {},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire1073")
